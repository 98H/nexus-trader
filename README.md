...
[![Live Deployment](https://img.shields.io/badge/Deployment-Live%20Preview-8b5cf6?style=for-the-badge)](/preview/prod-trader-88d6ef/)
...
- **پیوند دسترسی زنده (Live Preview):** [/preview/prod-trader-88d6ef/](/preview/prod-trader-88d6ef/)
...
```bash
# ۱. کلون ریپازیتوری
git clone https://github.com/98H/nexus-trader.git
cd nexus-trader
...
- **تاریخ آخرین همگام‌سازی:** 2026-09-19 16:16:38 UTC